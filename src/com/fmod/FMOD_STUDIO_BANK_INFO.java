...
public class FMOD_STUDIO_BANK_INFO {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        javafmodJNI.delete_FMOD_STUDIO_BANK_INFO(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setSize(int value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_size_set(swigCPtr, this, value);
  }

  public int getSize() {
    return javafmodJNI.FMOD_STUDIO_BANK_INFO_size_get(swigCPtr, this);
  }

  public void setUserData(SWIGTYPE_p_void value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_userData_set(swigCPtr, this, SWIGTYPE_p_void.getCPtr(value));
  }

  public SWIGTYPE_p_void getUserData() {
    long cPtr = javafmodJNI.FMOD_STUDIO_BANK_INFO_userData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
  }

  public void setUserDataLength(int value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_userDataLength_set(swigCPtr, this, value);
  }

  public int getUserDataLength() {
    return javafmodJNI.FMOD_STUDIO_BANK_INFO_userDataLength_get(swigCPtr, this);
  }

  public void setOpenCallback(SWIGTYPE_p_f_p_q_const__char_p_unsigned_int_p_p_void_p_void__FMOD_RESULT value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_openCallback_set(swigCPtr, this, SWIGTYPE_p_f_p_q_const__char_p_unsigned_int_p_p_void_p_void__FMOD_RESULT.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_q_const__char_p_unsigned_int_p_p_void_p_void__FMOD_RESULT getOpenCallback() {
    long cPtr = javafmodJNI.FMOD_STUDIO_BANK_INFO_openCallback_get(swigCPtr, this);
  ...
  public void setCloseCallback(SWIGTYPE_p_f_p_void_p_void__FMOD_RESULT value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_closeCallback_set(swigCPtr, this, SWIGTYPE_p_f_p_void_p_void__FMOD_RESULT.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_void_p_void__FMOD_RESULT getCloseCallback() {
    long cPtr = javafmodJNI.FMOD_STUDIO_BANK_INFO_closeCallback_get(swigCPtr, this);
  ...
  public void setReadCallback(SWIGTYPE_p_f_p_void_p_void_unsigned_int_p_unsigned_int_p_void__FMOD_RESULT value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_readCallback_set(swigCPtr, this, SWIGTYPE_p_f_p_void_p_void_unsigned_int_p_unsigned_int_p_void__FMOD_RESULT.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_void_p_void_unsigned_int_p_unsigned_int_p_void__FMOD_RESULT getReadCallback() {
    long cPtr = javafmodJNI.FMOD_STUDIO_BANK_INFO_readCallback_get(swigCPtr, this);
  ...
  public void setSeekCallback(SWIGTYPE_p_f_p_void_unsigned_int_p_void__FMOD_RESULT value) {
    javafmodJNI.FMOD_STUDIO_BANK_INFO_seekCallback_set(swigCPtr, this, SWIGTYPE_p_f_p_void_unsigned_int_p_void__FMOD_RESULT.getCPtr(value));
  }

  public SWIGTYPE_p_f_p_void_unsigned_int_p_void__FMOD_RESULT getSeekCallback() {
    long cPtr = javafmodJNI.FMOD_STUDIO_BANK_INFO_seekCallback_get(swigCPtr, this);
